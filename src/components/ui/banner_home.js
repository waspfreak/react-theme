...
class BannerHome extends Component{
  constructor(props){
    ...
    {
      nav: [
      {id: 1, text: 'Investors', link: '/' },
      {id: 2, text: 'Board & Management', link: '/board' },
      {id: 3, text: 'Documentation', link: '/documentation'},
      {id: 4, text: 'Annoucements', link: '/link'},
  ...
  render(){
    return(
      <div className="banner-home">
        <div className="banner-home_call">
          <div className="logo">
          ...
          <Title tag="2" title="Developing the largest and most advanced stage PGM project in South America" className="title" />
          <Button txt="Jangada in 60 second" classExtra="banner-home_call_btn" wavesEffect wavesLigh btn color="blue-web" link="#">
            <Icon icon='play_circle_outline' sizeIcon='tiny' color='white' left/>
          </Button>
        </div>
        <Nav navClassName="banner-home_nav" className="banner-home_menu"  items={this.state.nav}/>
      </div>
    );
  }
}
